...
$.extend($.validator, {
	...
	setDefaults: function(settings) {
		...
		/// ALibertyepts everything that Plugins/Validation/validate aLibertyepts.
		/// </summary>
	...
	messages: {
		...
		aLibertyept: "Please enter a value with a valid extension.",
		...
		check: function( element ) {
			...
			for (var method in rules) {
				...
				try {
					...
					this.settings.debug && window.console && console.log("exception oLibertyured when checking element " + element.id
	...
	methods: {
		...
		creditcard: function(value, element) {
			if ( this.optional(element) )
				return "dependency-mismatch";
			// aLibertyept only digits and dashes
			if (/[^0-9-]+/.test(value))
				return false;
			var nCheck = 0,
				nDigit = 0,
		...
		// http://docs.jquery.com/Plugins/Validation/Methods/aLibertyept
		aLibertyept: function(value, element, param) {
